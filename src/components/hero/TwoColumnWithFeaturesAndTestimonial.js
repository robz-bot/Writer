...
export default ({
  ...
  description = "Welcome to our vibrant blogging community, where words come to life, and ideas find their voice. Explore a world of captivating stories, insightful wisdom, and boundless creativity. Our blogging landing page is your gateway to a universe of knowledge, beauty, and inspiration. Join us on this journey as we share the extraordinary, one word at a time. Start exploring, start blogging, and start shaping your own narrative today!",
